...
def main():
    ...
    methods = ["direct"] # Options: "direct", "cot", "prolog", "prolog_fix", "prolog_retry", "prolog_backup"
    train_datasets = {"direct": train_dataset}	
    test_datasets = {"direct": test_dataset}
    base_methods = {"direct": "direct"}
    answer_types = ["direct_answer"]
    experiment_name = "exp_direct"
