...
def main():
    ...
    methods = ["cot", "direct"] # Options: "direct", "cot", "prolog", "prolog_fix", "prolog_retry", "prolog_backup"
    train_datasets = {"cot": train_dataset, "direct": train_dataset}	
    test_datasets = {"cot": test_dataset, "direct": test_dataset}
    base_methods = {"cot": "cot", "direct": "direct"}
    answer_types = ["cot_answer", "direct_answer"]
    experiment_name = "exp_cot"
    rewards = None
