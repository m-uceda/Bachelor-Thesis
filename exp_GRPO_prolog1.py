...
def main():
    ...
    train_json_file = "prolog1_train_data.json" # Change to name corresponding to the dataset you want to use
    test_json_file = "prolog1_test_data.json"
    train_json_dataset = get_data(train_json_file, PROLOG_PROMPT_1, TRAIN_JSON_FILE)
    dev_json_dataset = get_data(test_json_file, PROLOG_PROMPT_1, DEV_JSON_FILE)
    ...
    experiment_name = "exp_GRPO_prolog1"
