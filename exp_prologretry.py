...
def main():
    ...
    methods = ["prolog_retry"] # Options: "direct", "cot", "prolog", "prolog_fix", "prolog_retry", "prolog_backup"
    train_datasets = {"prolog_retry": train_dataset}	
    test_datasets = {"prolog_retry": test_dataset}
    base_methods = {"prolog_retry": "prolog"}
    answer_types = ["prolog_retry_answer"]
    experiment_name = "exp_prologretry"
